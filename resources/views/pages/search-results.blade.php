...
<body class=" yui3-skin-sam controls-visible signed-out public-page site" data-spy="scroll" data-target=".fixedMenu">
    ...
    <div>
                                                        ...
                                                        <div class="row-fluid rowTitleImage ">
                                                            ...
                                                            <div style="margin-top: 1rem;"
                                                                ...
                                                                <div class="portlet-body">
                                                                    ...
                                                                    <link rel="stylesheet"
                                                                        href="{{ asset('o/ricercaimprese/css/main.css') }}">
                                                                    <link rel="stylesheet"
                                                                        href="/o/ricercaimprese/css/risultatiRicerca.css">
                                                                    ...
                                                                    <div class="row ">
                                                                        ...
                                                                        <div class="col-md-12 span12">
                                                                            ...
                                                                            <div class="row-fluid rowHaiCercato">
                                                                                <div class="span12 spanHaiCercato">
                                                                                    ...
                                                                                    <div class="row-fluid"
                                                                                        ...
                                                                                        <div class="span12">
                                                                                            <h3
                                                                                                class="color-dark-grey labelTextField">
                                                                                                You searched for:
                                                                                                <span
                                                                                                    class="color-red">{{ strtoupper($result->company_name) }}
                                                                                                </span>
                                                                                            </h3>
                                                                                        </div>
                                                                                    </div>
                                                                            ...
                                                                            <div
                                                                                class="row-fluid margin-top-30-no-mobile">
                                                                                <div class="span12">
                                                                                    <div class="taglib-search-iterator-page-iterator-top"
                                                                                        style="display:none">

                                                                                        <div class="taglib-page-iterator"
                                                                                            id="_risultatiricercaimprese_WAR_ricercaPIportlet_BrPageIteratorTop">

                                                                                            <div
                                                                                                class="clearfix lfr-pagination">

                                                                                                <div
                                                                                                    class="lfr-pagination-config">
                                                                                                    <div
                                                                                                        class="lfr-pagination-page-selector">
                                                                                                        <div
                                                                                                            class="btn-group lfr-icon-menu current-page-menu">
                                                                                                            <a class="dropdown-toggle direction-down max-display-items-15 btn btn-secondary"
                                                                                                                href="javascript:void(0);"
                                                                                                                id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx_column_2d_2_0_menu"
                                                                                                                role="button"
                                                                                                                title="Page 1 of 131,328"><span
                                                                                                                    class="lfr-icon-menu-text">Page
                                                                                                                    1 of
                                                                                                                    131,328</span>
                                                                                                                <i
                                                                                                            ...
                                                                                                            <ul
                                                                                                                class="dropdown-menu lfr-menu-list direction-down">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        ...
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__1"
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__2"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d2')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__3"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d3')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__4"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d4')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__5"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d5')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__6"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d6')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__7"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d7')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__8"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d8')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__9"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d9')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__10"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d10')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">10</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__11"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d11')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">11</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__12"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d12')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">12</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__13"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d13')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">13</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__14"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d14')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">14</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__15"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d15')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">15</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__16"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d16')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">16</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__17"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d17')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">17</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__18"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d18')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">18</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__19"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d19')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">19</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__20"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d20')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">20</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__21"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d21')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">21</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__22"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d22')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">22</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__23"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d23')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">23</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__24"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d24')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">24</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__25"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d25')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">25</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_kldx__column__2d__2__0__menu__26"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d26')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">26</span>
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="lfr-pagination-delta-selector">


                                                                                                        <div
                                                                                                            class="btn-group lfr-icon-menu">
                                                                                                            <a class="dropdown-toggle direction-down max-display-items-15 btn btn-secondary"
                                                                                                                href="javascript:void(0);"
                                                                                                                id="_risultatiricercaimprese_WAR_ricercaPIportlet_tiym_column_2d_2_0_menu"
                                                                                                                role="button"
                                                                                                                title="10 Items per page"><span
                                                                                                                    class="lfr-icon-menu-text">10
                                                                                                                    Items
                                                                                                                    per
                                                                                                                    page</span>
                                                                                                                <i
                                                                                                            ...
                                                                                                            <ul
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_tiym__column__2d__2__0__menu__10"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d1\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_tiym__column__2d__2__0__menu__20"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d1\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d20')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_tiym__column__2d__2__0__menu__30"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d1\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d30')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">30</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_tiym__column__2d__2__0__menu__50"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d1\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d50')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">50</span>
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_tiym__column__2d__2__0__menu__75"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d1\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d75')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="taglib-text-icon">75</span>
                                                                                                ...
                                                                                                <small
                                                                                                    ...
                                                                                                    of <span
                                                                                                        class="risTot"
                                                                                                        style="display: inline;">1.313.275</span>
                                                                                                    results
                                                                                                ...
                                                                                                <ul
                                                                                                    class="lfr-pagination-buttons pagination">

                                                                                                    <li
                                                                                                        class="disabled first page-item">
                                                                                                        <a href="javascript:void(0);"
                                                                                                            page-link=""
                                                                                                            onclick=""
                                                                                                            tabindex="-1"
                                                                                                    ...
                                                                                                    <li
                                                                                                        ...
                                                                                                        <a href="https://italianbusinessregister.it/en/search-results?p_p_id=risultatiricercaimprese_WAR_ricercaPIportlet&amp;p_p_lifecycle=1&amp;p_p_state=normal&amp;p_p_mode=view&amp;_risultatiricercaimprese_WAR_ricercaPIportlet_javax.portlet.action=search&amp;_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate=S&amp;_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore=N&amp;_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9.n6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8&amp;_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur=false&amp;p_auth=q1WIaA5s&amp;_risultatiricercaimprese_WAR_ricercaPIportlet_delta=10&amp;_risultatiricercaimprese_WAR_ricercaPIportlet_cur=131328"
                                                                                                            page-link=""
                                                                                                            onclick=""
                                                                                                            tabindex="0"
                                                                                                            target="_self">
                                                                                    ...
                                                                                    <div id="modalBuyDocs_1"
                                                                                        class="modal modal-docs fade"
                                                                                        data-keyboard="false"
                                                                                        ...
                                                                                        <div class="modal-header">
                                                                                            <button type="button"
                                                                                                class="close"
                                                                                                onclick="closeModalDocs(1)">×</button>
                                                                                            <h3 id="myModalLabel"
                                                                                                class="text-center">
                                                                                                <b class="color-red">Buy
                                                                                                    documents</b>
                                                                                            </h3>
                                                                                        </div>
                                                                                        <div class="modal-body">
                                                                                            <h5 class="text-center">
                                                                                                <b class="color-black">SEAPRIDE
                                                                                                    ENGINEERING
                                                                                                    S.R.L.</b>&nbsp;
                                                                                            </h5>
                                                                                    ...
                                                                                    <div id="modalGlobalMap_IM-224289"
                                                                                        class="modal modal-docs fade"
                                                                                        data-keyboard="false"
                                                                                        data-backdrop="static"
                                                                                        tabindex="-1" role="dialog"
                                                                                        ...
                                                                                        <div class="modal-header">
                                                                                            <button type="button"
                                                                                                class="close"
                                                                                                onclick="closeGlobalMap('IM-224289')">×</button>
                                                                                            <h3 id="myModalLabel"
                                                                                                class="text-center">
                                                                                                <b class="color-red"
                                                                                                    style="text-transform:uppercase;">REGISTERED
                                                                                                    OFFICE AND LOCAL
                                                                                                    BRANCHES</b>
                                                                                            </h3>
                                                                                        </div>
                                                                                        <div class="modal-body"
                                                                                            style="max-height: 530px; height: 100%;padding:0px; ">
                                                                                            <input type="hidden"
                                                                                                class="initMap"
                                                                                                value="false">
                                                                                            <div class="map_canvas"
                                                                                                id="map_canvas_IM-224289">

                                                                                                <img src="/o/ricercaimprese/images/spinner.svg"
                                                                                                    alt="Wait"
                                                                                                    style="width:15%">
                                                                                            </div>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <img src="https://maps.google.com/mapfiles/ms/icons/blue-dot.png"
                                                                                                    style="margin-left:30px">&nbsp;&nbsp;<b
                                                                                                    style="text-transform:uppercase;">LOCAL
                                                                                                    BRANCHES<b>

                                                                                                    </b></b>
                                                                                            </div><b
                                                                                                style="text-transform:uppercase;"><b>
                                                                                                </b></b>
                                                                                        </div><b
                                                                                            style="text-transform:uppercase;"><b>
                                                                                            </b></b>
                                                                                    ...
                                                                                    <table
                                                                                        class="table tableRisultatiGratuita">
                                                                                        <tbody>
                                                                                                ...
                                                                                                <td colspan="8"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <a onclick="addTagManagerForDetail();blockScreen()"
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            class="imgLogoGratuita">


                                                                                                                            <img src="{{ asset('o/ricercaimprese/images/S_OK.png') }}"
                                                                                                                                alt="ko">
                                                                                                            ...
                                                                                                            <div
                                                                                                                class="span4 spanDenominazioneLista ">
                                                                                                                <div
                                                                                                                    class="row-fluid">
                                                                                                                    <div
                                                                                                                        class="span12">
                                                                                                                        <span
                                                                                                                            class="limitaDimensioneRic">
                                                                                                                            {{ $result->company_name }}
                                                                                                                        </span>
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <img src="{{ asset('o/ricercaimprese/images/worldwide.svg') }}"
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <a
                                                                                                                href="/company-details?cid={{ $result->id }}">
                                                                                                                <button
                                                                                                                    type="button"
                                                                                                                    class="btn btn-primary btn-small btn-buy-doc"><b>View
                                                                                                                        details</b></button>
                                                                                                            </a>
                                                                                                        </div>
                                                                                ...
                                                                                style="text-transform:uppercase;"><b>
                                                                                    ...
                                                                                    <div class="taglib-search-iterator-page-iterator-bottom"
                                                                                        ...
                                                                                        <div class="taglib-page-iterator"
                                                                                            id="_risultatiricercaimprese_WAR_ricercaPIportlet_BrPageIteratorBottom">
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <a class="dropdown-toggle direction-down max-display-items-15 btn btn-secondary"
                                                                                                                href="javascript:void(0);"
                                                                                                                id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj_column_2d_2_0_menu"
                                                                                                                role="button"
                                                                                                                title="Page 1 of 131,328"><span
                                                                                                                    class="lfr-icon-menu-text">Page
                                                                                                                    1 of
                                                                                                            ...
                                                                                                            <ul
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__1"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d1')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__2"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d2')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__3"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d3')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__4"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d4')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__5"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d5')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__6"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d6')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__7"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d7')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__8"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d8')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__9"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d9')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__10"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d10')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__11"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d11')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__12"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d12')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__13"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d13')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__14"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d14')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__15"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d15')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__16"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d16')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__17"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d17')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__18"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d18')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__19"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d19')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__20"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d20')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__21"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d21')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__22"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d22')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__23"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d23')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__24"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d24')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__25"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d25')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_hjzj__column__2d__2__0__menu__26"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d26')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <a class="dropdown-toggle direction-down max-display-items-15 btn btn-secondary"
                                                                                                                href="javascript:void(0);"
                                                                                                                id="_risultatiricercaimprese_WAR_ricercaPIportlet_dhec_column_2d_2_0_menu"
                                                                                                                role="button"
                                                                                                                title="10 Items per page"><span
                                                                                                                    class="lfr-icon-menu-text">10
                                                                                                                    Items
                                                                                                            ...
                                                                                                            <ul
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_dhec__column__2d__2__0__menu__5"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d1\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d5')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_dhec__column__2d__2__0__menu__10"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d1\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d10')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_dhec__column__2d__2__0__menu__20"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d1\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d20')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_dhec__column__2d__2__0__menu__30"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d1\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d30')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_dhec__column__2d__2__0__menu__50"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d1\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d50')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                                                                ...
                                                                                                                <li class=""
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0);"
                                                                                                                        target="_self"
                                                                                                                        class=" dropdown-item lfr-icon-item taglib-icon"
                                                                                                                        id="_risultatiricercaimprese_WAR_ricercaPIportlet_dhec__column__2d__2__0__menu__75"
                                                                                                                        onclick="event.preventDefault();submitForm(document.hrefFm, 'https\x3a\x2f\x2fitalianbusinessregister\x2eit\x2fen\x2fsearch-results\x3fp_p_id\x3drisultatiricercaimprese_WAR_ricercaPIportlet\x26p_p_lifecycle\x3d1\x26p_p_state\x3dnormal\x26p_p_mode\x3dview\x26_risultatiricercaimprese_WAR_ricercaPIportlet_javax\x2eportlet\x2eaction\x3dsearch\x26_risultatiricercaimprese_WAR_ricercaPIportlet_soloNonCancellate\x3dS\x26_risultatiricercaimprese_WAR_ricercaPIportlet_filtroScore\x3dN\x26_risultatiricercaimprese_WAR_ricercaPIportlet_pageToken\x3deyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\x2eeyJjb3VudCI6MjUwLCJleHAiOjE3NjQxODczMDh9\x2en6uv4hU4-PLd9l5OqNYiOhm1b9qzLkbvbEnWilSPTI8\x26_risultatiricercaimprese_WAR_ricercaPIportlet_cur\x3d1\x26_risultatiricercaimprese_WAR_ricercaPIportlet_resetCur\x3dfalse\x26p_auth\x3dq1WIaA5s\x26_risultatiricercaimprese_WAR_ricercaPIportlet_delta\x3d75')"
                                                                                                                        data-senna-off="true"
                                                                                                                        aria-haspopup="dialog">
                                                                        ...
                                                                        </div><b style="text-transform:uppercase;"><b>
                                                                            ...
                                                                            <script>
                                                                                jQuery(document).ready(function() {
                                                                                    setTimeout(function() {
                                                                                        ...
                                                                                        jQuery(".page-item").children("a").not(".disabled > a, .last > a, .first > a").on("click",
                                                                                            function(e) {
                                                                                                e.preventDefault();
                                                                                                blockScreen();
                                                                                                //disabilito per evitare multiclick
                                                                                                jQuery(".page-item").children("a").css("pointer-events", "none").css("color",
                                                                                                    "gray");
                                                                                                var hrefNextPage = jQuery(this).prop("href");
                                                                                                blockScreen();
                                                                                                grecaptcha.enterprise.execute("6LfKBJ4qAAAAAKvP_8mDvmi8kDPBRDk6bYU8aCAe", {
                                                                                                        action: 'submit'
                                                                                                    })
                                                                                                    .then(function(token) {
                                                                                                        blockScreen();
                                                                                        ...
                                                                                        jQuery('a.dropdown-item').not('.current-page-menu a').each(function() {
                                                                                            ...
                                                                                            if (onclickAttr) {
                                                                                                ...
                                                                                                let targetUrlMatch = onclickAttr.match(
                                                                                                    /submitForm\(document.hrefFm,\s*'(.*?)'\)/);
                                                                                                if (targetUrlMatch && targetUrlMatch[1]) {
                                                                                                    let targetUrl = (targetUrlMatch[1]).replace(/\\x([0-9A-Fa-f]{2})/g, (
                                                                                                    ...
                                                                                                    $anchor.removeAttr("onclick").on("click", function(event) {
                                                                                                        event
                                                                                                            .preventDefault(); // Evita che il link venga subito eseguito
                                                                                                        blockScreen();
                                                                                                        // Esegui reCAPTCHA prima di procedere
                                                                                                        grecaptcha.enterprise.execute(
                                                                                                                "6LfKBJ4qAAAAAKvP_8mDvmi8kDPBRDk6bYU8aCAe", {
                                                                                                                    action: 'submit'
                                                                                                                })
                                                                                                            .then(function(token) {
                                                                                                                blockScreen();
                                                                                                                // Dopo il successo di reCAPTCHA, invia il form con il token aggiunto
                                                                                                                jQuery("#hrefFm").attr("action", targetUrl +
                                                                                                                    "&captchaResp=" + token)
        ...
        <div id="modalLogin" class="modal modal-login" tabindex="-1" role="dialog"
            aria-labelledby="myModalLabel" aria-hidden="true" style="background-color:white;">
            <div class="modal-header">
