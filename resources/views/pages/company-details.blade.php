...
<head>
    ...
    <title>Company Details | Luxembourg Business Registers</title>
                    ...
                    <div class="portlet-layout row-fluid row-intest">
                        ...
                        <div class="portlet-column row-fluid width70auto" id="column-2">
                            <div class="portlet-dropzone portlet-column-content portlet-column-content-only"
                                ...
                                <div class="portlet-boundary portlet-boundary_risultatiricercaimprese_WAR_ricercaPIportlet_  portlet-static portlet-static-end portlet-borderless  "
                                    id="p_p_id_risultatiricercaimprese_WAR_ricercaPIportlet_">
                                    <span id="p_risultatiricercaimprese_WAR_ricercaPIportlet"></span>

                                    <section class="portlet"
                                        id="portlet_risultatiricercaimprese_WAR_ricercaPIportlet">
                                        ...
                                        <div class="portlet-content">
                                            ...
                                            <div class="autofit-float autofit-row portlet-header">
                                                ...
                                                <div class="autofit-col autofit-col-expand">
                                                    <h5 class="portlet-title-text">PI - Risultati Ricerca Imprese
                                                        Gratuita</h5>
                                                </div>
                                            ...
                                            <div class=" portlet-content-container">
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <link rel="stylesheet"
                                                        href="{{ asset('o/ricercaimprese/css/dettaglioImpresa.css') }}">
                                                        ...
                                                        <div class="span12">
                                                            ...
                                                            <div class="row-fluid rowTitleDetail"
                                                                ...
                                                                <div class="span12 spanHaiCercato">
                                                                    <h2 class="color-dark-grey labelTextField"
                                                                        style="position:relative"><b class="denom">
                                                                            Company Detail </b>
                                                                    </h2>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row-fluid marginTop30">
                                                        <div class="row-fluid rowTitleDetail">
                                                            <div class="span12 spanHaiCercato">
                                                                <h3 class="color-black" style="position:relative"><b
                                                                        class="denom">{{ strtoupper($company->company_name) }}</b>
                                                                    <img alt="ok"
                                                                        src="{{ asset('o/ricercaimprese/images/S_OK.png') }}"
                                                                        class="imgTitleDetail">
                                                                </h3>
                                                            </div>
                                                        </div>

                                                        <div class="span12 companyDetailContainer">

                                                            <div class="span8 spanInfoAnag">
                                                                <div class="row-fluid">
                                                                    <div class="span3 color-black">
                                                                        <b class="font16">Company Name</b>
                                                                    </div>
                                                                ...
                                                                <div class="row-fluid marginTop20">
                                                                    <div class="span3 color-black">
                                                                        <b class="font16">Registered Address</b>
                                                                    </div>
                                                                    <div class="span9 font16 infoDetail">
                                                                ...
                                                                <div class="row-fluid marginTop20">
                                                                    ...
                                                                    <div class="span9 font16 infoDetail"
                                                                        style="color: #005f5a !important; font-weight: bold !important; padding: 4px 12px !important; border-radius: 4px !important; background-color: #cbfbf1 !important; width: fit-content !important; font-size: 14px !important;">
                                                                ...
                                                                <div class="row-fluid marginTop20">
                                                                    <div class="span3 color-black">
                                                                        <b class="font16">Business Activities</b>
                                                                    </div>
                                                                    <div class="span9 font16 infoDetail">
                                                    ...
                                                    <div class="row-fluid marginTop20">
                                                        <div class="span12 divAvvertenza" style="font-size: 12">
                                                            <span>* NOTICE:
                                                                The service only provides information regarding the
                                                                presence of a digital domicile/PEC (certified e-mail
                                                                address) registered in the BR, and in no way guarantees
                                                                the correctness and validity thereof at the time.
                                                                The user consulting the Register therefore accepts that
                                                                the Chambers of Commerce and InfoCamere S.C.p.A. as
                                                                manager of the information system are not responsible in
                                                                any way for the correctness and validity of the digital
                                                                domicile/PEC entered in the Register itself.
                                                            </span>
                                                        </div>
                                                    </div>

                                                    <div id="modalPec" class="modal modalPec fade" tabindex="-1"
                                                        role="dialog" aria-labelledby="myModalLabel"
                                                        aria-hidden="true" data-backdrop="static">
                                                        <div class="modal-header">
                                                            <button type="button" class="close"
                                                                onclick="closeModalPec()">×</button>
                                                            <h3 class="text-center"><b>Digital mailbox/certified
                                                                    e-mail</b></h3>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="row-fluid">
                                                                <div class="span12">
                                                                    <span id="pecValue"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default btn-small"
                                                                onclick="closeModalPec();"><b>Close</b></button>
                                                        </div>
                                                    </div>
                    ...
                    <div class="portlet-layout row-fluid row-content">
                        ...
                        <div class="portlet-column row-fluid width70auto">
                            <div class="row-fluid" id="column-3">
                                <div class="span12">
                                    <div class="empty portlet-dropzone portlet-column-content portlet-column-content-only"
                                        id="layout-column_column-3"></div>
                                </div>
                            </div>
